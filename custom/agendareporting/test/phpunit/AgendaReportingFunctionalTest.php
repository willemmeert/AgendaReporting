...
/**
 * \file    test/functional/AgendaReportingFunctionalTest.php
...
/**
 * Class AgendaReportingFunctionalTest
 *
 ...
 *
 * @package Testagendareporting
 */
class AgendaReportingFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modAgendaReporting')->click();
		} else {
			// Disable the module
			$this->byHref('modAgendaReporting')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/agendareporting/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('agendareporting/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/agendareporting/admin/about.php');
		$this->authenticate();
		return $this->assertContains('agendareporting/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('agendareportingwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modAgendaReporting_AgendaReportingTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAgendaReporting_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
