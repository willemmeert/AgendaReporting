...
/**
 *	\file       agendareporting/agendareportingindex.php
 *	\ingroup    agendareporting
 *	\brief      Home page of agendareporting top menu
 */
...
$langs->loadLangs(array("agendareporting@agendareporting"));

$action=GETPOST('action', 'alpha');


// Security check
//if (! $user->rights->agendareporting->myobject->read) accessforbidden();
...
llxHeader("", $langs->trans("AgendaReportingArea"));

print load_fiche_titre($langs->trans("AgendaReportingArea"), '', 'agendareporting.png@agendareporting');
...
// Draft MyObject
if (! empty($conf->agendareporting->enabled) && $user->rights->agendareporting->read)
{
	$langs->load("orders");
